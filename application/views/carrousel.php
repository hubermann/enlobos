...
if($sliders){
	...
	foreach ($sliders as $slider) {
		$active = "";
		if($cantidad_sliders ==1){ $active = 'class="active"';}
		$cantidad_sliders= $cantidad_sliders +1;
		$imagen = 
		$items .= '<div class="item active" style="background-image: url('.base_url('images-sliders/'.$slider->filename).')">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
