...
$attributes = array('class' => 'form-horizontal', 'id' => 'new_categoria_comercio');
echo form_open_multipart(base_url('control/categoria_comercios/create/'),$attributes);

echo form_hidden('categoria_comercio[id]');
