<?php  
$attributes = array('class' => 'form-horizontal', 'id' => 'edit_categoria_publicacion');
echo form_open_multipart(base_url('control/categorias_publicaciones/update/'),$attributes);
