<?php  
$attributes = array('class' => 'form-horizontal', 'id' => 'delete_slider');
echo form_open(base_url('control/sliders/delete/'.$query->id), $attributes);
...
<div class="well well-large well-transparent">
 ...
 <p>Frase: <?php echo $query->frase; ?></p>
