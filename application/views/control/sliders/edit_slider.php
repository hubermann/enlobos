...
$attributes = array('class' => 'form-horizontal', 'id' => 'edit_slider');
echo form_open_multipart(base_url('control/sliders/update/'),$attributes);
...
-->
			...
			<div class="controls">
			<input value="<?php echo $query->frase; ?>" type="text" class="form-control" name="frase" />
			<?php echo form_error('frase','<p class="error">', '</p>'); ?>
			</div>
			</div>
	<!-- Text input-->
<div class="control-group">
	...
	echo '<p><img src="'.base_url('images-sliders/'.$query->filename).'" width="140" /></p>';
	} ?>
